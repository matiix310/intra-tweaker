import { editTheme, getCurrentDisplacement } from "./changeTheme";
...
const addColorPicker = () => {
  ...
  const style = localStorage.getItem("style") ?? "styleNone";
  ...
  <div style="display: flex;align-content: center;justify-content: space-around;">
    <a id="styleNone" class="style-button ${
      style == "styleNone" ? "selected" : ""
    }">none</a>
